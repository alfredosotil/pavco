...
public class EquivalentTestSamples {
    ...
    public static Equivalent getEquivalentSample1() {
        return new Equivalent().id(1L).uuid(UUID.fromString("23d8dc04-a48b-45d9-a01d-4b728f0ad4aa")).code("code1").name("name1");
    }

    public static Equivalent getEquivalentSample2() {
        return new Equivalent().id(2L).uuid(UUID.fromString("ad79f240-3727-46c3-b89f-2cf6ebd74367")).code("code2").name("name2");
    }
