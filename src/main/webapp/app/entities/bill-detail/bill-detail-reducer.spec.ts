...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BILLDETAIL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BILLDETAIL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BILLDETAIL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BILLDETAIL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BILLDETAIL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BILLDETAIL actions', async () => {
      const arg = 42666;
