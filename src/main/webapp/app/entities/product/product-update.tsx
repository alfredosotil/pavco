  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="pavcoApp.product.home.createOrEditLabel" data-cy="ProductCreateUpdateHeading">
            <Translate contentKey="pavcoApp.product.home.createOrEditLabel">Create or edit a Product</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('pavcoApp.product.uuid')}
                id="product-uuid"
                name="uuid"
                data-cy="uuid"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('pavcoApp.product.code')}
                id="product-code"
                name="code"
                data-cy="code"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('pavcoApp.product.price')}
                id="product-price"
                name="price"
                data-cy="price"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('pavcoApp.product.discount')}
                id="product-discount"
                name="discount"
                data-cy="discount"
                type="text"
              ...
              <ValidatedField
                ...
                name="productType"
                data-cy="productType"
                label={translate('pavcoApp.product.productType')}
                type="select"
              >
                <option value="" key="0" />
                {productTypes
