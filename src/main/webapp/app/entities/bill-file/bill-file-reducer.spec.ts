...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './bill-file.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BILLFILE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BILLFILE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BILLFILE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BILLFILE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BILLFILE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BILLFILE actions', async () => {
      const arg = 42666;
