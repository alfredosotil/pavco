...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EQUIVALENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EQUIVALENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EQUIVALENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_EQUIVALENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_EQUIVALENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_EQUIVALENT actions', async () => {
      const arg = 42666;
