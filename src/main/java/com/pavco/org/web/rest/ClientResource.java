...
/**
 * REST controller for managing {@link com.pavco.org.domain.Client}.
 */
@RestController
...
public class ClientResource {
    ...
    public ResponseEntity<ClientDTO> createClient(@Valid @RequestBody ClientDTO clientDTO) throws URISyntaxException {
        ...
        if (Objects.isNull(clientDTO.getUser())) {
    ...
    public List<ClientDTO> getAllClients(
        ...
        if ("equivalent-is-null".equals(filter)) {
            log.debug("REST request to get all Clients where equivalent is null");
            return clientService.findAllWhereEquivalentIsNull();
        }
