...
/**
 * REST controller for managing {@link com.pavco.org.domain.ProductType}.
 */
@RestController
...
public class ProductTypeResource {
     ...
     */
    @GetMapping("")
    public List<ProductTypeDTO> getAllProductTypes(@RequestParam(name = "filter", required = false) String filter) {
        if ("product-is-null".equals(filter)) {
            log.debug("REST request to get all ProductTypes where product is null");
            return productTypeService.findAllWhereProductIsNull();
        }
