...
/**
 * REST controller for managing {@link com.pavco.org.domain.Product}.
 */
@RestController
...
public class ProductResource {
    ...
    public List<ProductDTO> getAllProducts(
        ...
        if ("equivalent-is-null".equals(filter)) {
            log.debug("REST request to get all Products where equivalent is null");
            return productService.findAllWhereEquivalentIsNull();
        }
